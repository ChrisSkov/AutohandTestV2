...
namespace Autohand{
    ...
    public class HandTeleportGuard : MonoBehaviour{
        ...
        void Awake(){
            ...
            mask = LayerMask.GetMask(Hand.grabbableLayerNameDefault, Hand.grabbingLayerName, Hand.releasingLayerName, Hand.rightHandLayerName, Hand.rightHandHoldingLayerName, Hand.leftHandLayerName, Hand.leftHandHoldingLayerName, "HandPlayer");
        }
